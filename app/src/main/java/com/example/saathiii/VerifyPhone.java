...
public class VerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_resend_otp).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendVerificationCode(mobile);
                Toast.makeText(VerifyPhone.this, "OTP Resended", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        findViewById(R.id.buttonSignIn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.isEmpty() || code.length() < 6) {
                    Toast.makeText(VerifyPhone.this, "Enter valid code", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                .addOnCompleteListener(VerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerifyPhone.this, Create_Pass.class);
